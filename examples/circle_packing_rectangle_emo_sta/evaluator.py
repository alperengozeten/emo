"""Evaluator for the EMO-STA rectangle circle-packing family."""
    ...
    *,
    ...
    return textwrap.dedent(
        ...
        try:
            ...
            module_name = "circle_packing_rectangle_emo_sta_candidate"
...
def _run_program_in_subprocess(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="circle_packing_rectangle_emo_sta_") as temp_dir:
    ...
    *,
    ...
    if task_results:
        ...
        artifacts["best_local_summary"] = {
            ...
            "alpha": float(best_local_result["metrics"]["alpha"]),
        }
